...
<footer className="bg-slate-900 text-white pt-12 pb-6">
  <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-4 gap-8">
    ...
    {/* Logo / About */}
    <div>
      <h2 className="text-2xl font-black mb-3 text-amber-400">CarScout 🚗</h2>
      <p className="text-sm text-slate-400">
        Buy and sell cars smarter with verified listings, real buyers, and powerful tools.
      </p>
    </div>
    ...
    <div>
      ...
      <ul className="space-y-2 text-sm text-slate-400">
        ...
        <li><Link to="/customer" className="hover:text-white">Buy Cars</Link></li>
        <li><button onClick={() => setIsSellWizardOpen(true)} className="hover:text-white">Sell Car</button></li>
        {canOpenAdminPanel && (
          <li><Link to="/adminpanel/dashboard" className="hover:text-white">Admin Panel</Link></li>
        )}
      </ul>
    </div>
    ...
    <div>
      ...
      <p className="text-sm text-slate-400">📧 support@carscout.com</p>
      <p className="text-sm text-slate-400">📍 India</p>

      <div className="flex gap-3 mt-3">
        <span className="bg-slate-800 px-3 py-1 rounded-full text-xs">FB</span>
        <span className="bg-slate-800 px-3 py-1 rounded-full text-xs">IG</span>
        <span className="bg-slate-800 px-3 py-1 rounded-full text-xs">TW</span>
      </div>
    </div>
  ...
  {/* Bottom */}
  <div className="text-center text-sm text-slate-500 mt-10 border-t border-slate-700 pt-4">
    © {new Date().getFullYear()} CarScout. All rights reserved.
  </div>
</footer>
